...
void sort(int array[], int size){//if we do it with characters change int array[] to char
...
void print_array(int array[], int size){//if we do it with characters change int array[] to char
