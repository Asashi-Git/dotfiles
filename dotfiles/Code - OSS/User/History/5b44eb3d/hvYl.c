...
void sort(char array[], int size){//if we do it with characters change int array[] to char
...
void print_array(char array[], int size){//if we do it with characters change int array[] to char
    // Iterate through the array and print each element
    for(int i = 0; i < size; i++){
        printf("%c ", array[i]);//if we do it with characters, change the %d to %c
    }
}
