...
<div id="root">
  ...
  <img src="image\logo.png" class="logo">
    ...
    <nav role="navigation" id="topnav_menu" class="nav">
		...
		<a class="topnav_link" href="index-restau.php">RESTAURANT</a>
		<a class="topnav_link" href="spa.php">SPA</a>
		<?php 
...
<?php
		if (!isset($_SESSION["client_id"])) {
			...
			<a class="topnav_link" href="connexion-inscription.php">CONNEXION</a>
			<?php
		} else {
			?>
    ...
    <nav role="navigation" id="topnav_responsive_menu">
      <ul>
        ...
        <li class="burger"><a href="index-restau.php">RESTAURANT</a></li>
        <li class="burger"><a href="spa.php">SPA</a></li>
		<?php 
			if (isset($_SESSION["client_id"])){?>
