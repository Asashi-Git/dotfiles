...
int main(){
    ...
    int rows = sizeof(numbers2) / sizeof(numbers2[0]);//dividing the size of the variable by the size of one column = size of a rocharw
    int colums = sizeof(numbers2[0]) / sizeof(numbers2[0][0]);
