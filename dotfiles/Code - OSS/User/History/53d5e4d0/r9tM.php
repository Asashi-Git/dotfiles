            ...
            <div id="my-projects" class="project-grid">
                ...
                <div class="project-card">
                    <div class="project-image">
                        <img src="images/bankSO.png" alt="Project 1">
                    </div>
                    <div class="project-info">
                        <h3>Virtualisation Of A Bank Network</h3>
                        <p>This is a project that I did for my school. They ask us to build a secure network for a Bank Named BankSO. This project was made in 4 days.</p>
                        ...
                        <a href="/projects/network-project/PROJET-RESEAU-BANKSO.pdf" target="_blank" class="project-link">View Project <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>

                <div class="project-card">
                    <div class="project-image">
                        <img src="images/portfolio.PNG" alt="Project 2">
                    </div>
                    <div class="project-info">
                        <h3>Hosting My Portfolio on my Proxmox Hypervisor</h3>
                ...
                <div class="project-card">
                    <div class="project-image">
                        <img src="images/proxmoxx.webp" alt="Project 3">
                    </div>
                    <div class="project-info">
                        <h3>I Built My Own Server Using Proxmox as my Hypervisor</h3>
                        <p>I built a server with a Proxmox hypervisor, to be able to create VM machines from anywhere. I configure a VPN too, to allow distant connection.</p>
                        <div class="project-tags">
                            <span>Network</span>
                            <span>Linux</span>
                            <span>VPN</span>
                ...
                <div class="project-card">
                    <div class="project-image">
                        <img src="images/forest-scroll.PNG" alt="Project 4">
                    </div>
                    <div class="project-info">
                ...
                <div class="project-card">
                    <div class="project-image">
                        <img src="images/sipder-effect.PNG" alt="Project 5">
                    </div>
                    <div class="project-info">
                ...
                <div class="project-card">
                    <div class="project-image">
                        <img src="images/mountain-parallax.PNG" alt="Project 6">
                    </div>
                    <div class="project-info">
