                ...
                <div class="reservation">
                    ...
                    <form action="/cible" method="POST">
                        ...
                        <select name="nb-personne" id="nb-personne">
                            <option value="1personne">1 Personne</option>
                            <option value="2personne">2 Personnes</option>
                            <option value="3personne">3 Personnes</option>
                            <option value="4personne">4 Personne</option>
                            <option value="5personne">5 Personnes</option>
                            <option value="6personne">6 Personnes</option>
                        </select>
                        <br>
