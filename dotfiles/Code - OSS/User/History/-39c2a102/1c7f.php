...
<section class="accordeon-2">
            <h2>L'ACCORDEON</h2>
            <div class="section-2 ">
                <i class="petit-accordeon-2"></i> Section 1
            </div>
            <div class="petit-accordeon-2">je suis le contenu de la section 1</div>
            <div class="section-2">
                <i class="petit-accordeon-2"></i>Section 2
            </div>
            <div class="petit-accordeon-2">je sui le contenu de la section 2</div>
            <div class="section-2">
                <i class="petit-accordeon-2"></i> Section 3
            </div>
            <div class="petit-accordeon-2">je suis le contenu de la section 3.</div>
        </section>
