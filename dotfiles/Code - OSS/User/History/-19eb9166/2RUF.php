        ...
        <div class="list">
            <div class="item">
                ...
                <div class="content">
                    ...
                    <div class="buttons">
                        <a href="info.php" class="buttons"><button>SEE MORE</button></a>
                        <button>RESERVATION</button>
                        <button type="button" onclick="window.location.href='info.php';" class="button-style">Aller à Nouveau Fichier</button>
                    </div>
                </div>
            </div>
            <div class="item">
